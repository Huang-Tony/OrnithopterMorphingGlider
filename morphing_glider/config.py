...
TOTAL_TRAIN_STEPS = 1_000_000 if PAPER_RUN else (500_000 if MEDIUM_RUN else 20_000)
...
REPLAY_RETAIN_FRACTION = 0.70
REPRO_TOLERANCE = 0.10
...
REWARD_W_JERK = 0.08
REWARD_W_POWER = 0.08
REWARD_W_STRUCT = 0.50
REWARD_W_ZSYM = 0.05
REWARD_CLIP_MIN = -5.0
REWARD_CLIP_MAX = 12.0
REWARD_SURVIVAL_BONUS = 0.30
REWARD_TRACKING_SHARPNESS = 7.0
REWARD_W_WALL = 3.0
